...
mach_array = np.linspace(8,12,num=100)

data = parametrize_scramjet(scale_factors, input_vals, mach_array=mach_array)
data2 = data.parametrize_mach()
...
plt.style.use('bmh')
plt.xlabel('Freestream Mach', fontsize = 15)
